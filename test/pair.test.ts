...
describe('Pair', () => {
  const DAI = new Token(ChainId.MAINNET, '0x04068da6c83afcfa0e13ba15a6696662335d5b75', 6, 'USDC', 'USD Coin')
  const USDC  = new Token(ChainId.MAINNET, '0x8d11ec38a3eb5e956b052f67da8bdc9bef8abf3e', 18, 'DAI', 'DAI Stablecoin')
  ...
  describe('#getAddress', () => {
    it('returns the correct address', () => {
      expect(Pair.getAddress(USDC, DAI)).toEqual('0x9606D683d03f012DDa296eF0ae9261207C4A5847')
    })
  })
